...
frame = frame.pop();
output += "\n                    \n                    </select>\n                </div>\n            </div>\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-edit-title-pt\">Title (pt)</label>\n            <input type=\"text\" id=\"js-edit-title-pt\" class=\"form-control\" name=\"title-pt\" value=\"";
...
output += "\">\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-edit-title-en\">Title (en)</label>\n            <input type=\"text\" id=\"js-edit-title-en\" class=\"form-control\" name=\"title-en\" value=\"";
...
output += "\">\n                </div>\n\n            </div>  \n\n            <div class=\"col-sm-6\">\n\n                <div class=\"form-group\">\n                    <label for=\"js-edit-time-data\">Time data</label>\n                    <select id=\"js-edit-time-data\" name=\"time-data\" class=\"form-control\">\n                        <option  value=\"no\">No </option>\n                        <option  value=\"yes\" ";
...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "name"), env.autoesc);
output += "</h4>\n</div>\n\n\n<div class=\"modal-body\">\n    <form>\n\n        <div class=\"form-group\">\n            <label for=\"js-code\">Code</label>\n            <input type=\"text\" id=\"js-code\" class=\"form-control\" name=\"code\" >\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-title-pt\">Title (português)</label>\n            <input type=\"text\" id=\"js-title-pt\" class=\"form-control\" name=\"title-pt\" >\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-title-en\">Title (english)</label>\n            <input type=\"text\" id=\"js-title-en\" class=\"form-control\" name=\"title-en\" >\n        </div>\n\n\n        <div class=\"form-group\">\n            <label for=\"js-category-id\">Category</label>\n            <select name=\"category-id\" class=\"form-control\">\n\n            ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "mapCategories");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["texts3/templates/texts-delete-modal.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
